...
<div class="card mb-3 text-center">
    ...
    <div class="card-body bg-light">
        <div class="card-text">
            Joseph Kosuth's <i>Art as Idea as Idea</i> work, Radical at <a href="https://www.louisiana.dk/" target="_blank">Louisiana Museum of Modern Art</a>
        </div>
    </div>
</div>

**To better view the images** of this post right-click and "*view images*".
...
This is the fancy word that can describe Copenhagen: city of bikes! 

By the way, don't Google the word as I coined this word myself!
