...
As a proof, take a look at [Hawraman Takht](https://goo.gl/maps/ut4cYyTj4SsbyBYD7){:target="_blank"}.

Although Kurdish and Hawrami speaking regions are geographically contiguous and have been historically and culturally close together, there are significant differences when it comes to language. The common belief is that Hawrami is a dialect of Kurdish. At the time, I was not much aware of the linguistic differences of the two *languages* and was thinking of Hawraman as another Kurdish speaking region and therefore, was considering Hawrami as a dialect of Kurdish.
...
Download the Zaza-Gorani corpus at [https://github.com/klpp/pewan/](https://github.com/sinaahmadi/ZazaGoraniCorpus){:target="_blank"}.
