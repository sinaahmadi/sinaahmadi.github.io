...
#### 🆕 [Southern Kurdish](https://en.wikipedia.org/wiki/Southern_Kurdish) data added!
...
To find out more, read our [paper]({{ site.url }}/docs/articles/ahmadi2019kurdishlex.pdf){:target="_blank"}. Our data is available at [Kurdish lexicographical resources](https://github.com/sinaahmadi/KurdishLexicography){:target="_blank"}.
